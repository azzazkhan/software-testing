...
def test_messages_can_be_logged():
...
def test_logged_messages_are_written_to_log_file():
    contents = "My message"
    Logger.log(contents)
...
def test_logged_messages_are_appended_to_log_file():
...
def test_empty_line_is_added_at_end_of_logged_message():
...
def test_logged_messages_can_be_searched():
