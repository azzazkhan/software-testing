...
class FileManagerTest(unittest.TestCase):
    def test_files_can_be_written(self):
    ...
    def test_contents_can_be_appended(self):
        filename = get_filename()
        contents = "Test contents"
        FileManager.write(filename, contents)
    ...
    def test_contents_can_be_read_lazily(self):
        filename = get_filename()
    ...
    def test_files_can_be_deleted(self):
        filename = get_filename()
    ...
    def test_raises_error_when_deleting_non_existing_file(self):
        filename = get_filename() + "-non-existing.txt"

        func = lambda: FileManager.delete(get_realpath(filename))
        self.assertRaises(FileNotFoundError, func)
